                    ...
                    <form method="POST" action="{{ route('staff.update', $staff) }}">
                            ...
                            <div class="space-y-3">
                                <label class="flex items-center">
                                    <input type="radio" 
                                           name="staff_type" 
                                           value="military" 
                                           {{ old('staff_type', $staff->staff_type) === 'military' ? 'checked' : '' }}
                                ...
                                <label class="flex items-center">
                                    <input type="radio" 
                                           name="staff_type" 
                                           value="civilian" 
                                           {{ old('staff_type', $staff->staff_type ?? 'civilian') === 'civilian' ? 'checked' : '' }}
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   ...
                                   required
                                   placeholder="e.g., Military School, Graduate School, Administration, etc."
