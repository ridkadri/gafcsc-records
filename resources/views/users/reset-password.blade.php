                    ...
                    <div class="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
                        <div class="flex items-center">
                            <div class="h-12 w-12 rounded-full flex items-center justify-center text-white text-lg font-bold 
                                {{ $user->isSuperAdmin() ? 'bg-red-500' : 'bg-blue-500' }}">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-xs text-gray-500 mt-1">
                                    Current Role: <span class="font-medium">{{ $user->getRoleDisplayName() }}</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex">
                            ...
                            <div>
                                ...
                                <p class="text-yellow-700 text-sm mt-1">
                                    You are about to reset the password for <strong>{{ $user->name }}</strong> to the default system password.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <form method="POST" action="{{ route('users.reset-password', $user) }}">
                            ...
                            <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                                ...
                                <button type="submit" 
                                        ...
                                        onclick="return confirm('Are you sure you want to reset the password for {{ $user->name }} to the default?')">
