...
<div class="flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900"><?php echo e($inventoryCategory->name); ?></h1>
            <div class="flex items-center space-x-4 text-sm text-gray-600">
                <span>Code: <span class="font-mono"><?php echo e($inventoryCategory->code); ?></span></span>
                ...
                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($inventoryCategory->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
                        <?php if($inventoryCategory->is_active): ?>
    ...
    <div class="flex space-x-3">
        <a href="<?php echo e(route('inventory.categories.edit', $inventoryCategory)); ?>" 
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($inventoryCategory->name); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Category Code</dt>
                                <dd class="mt-1 text-sm text-gray-900 font-mono"><?php echo e($inventoryCategory->code); ?></dd>
                            </div>
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-gray-500">Description</dt>
                                <dd class="mt-1 text-sm text-gray-900">
                                    <?php echo e($inventoryCategory->description ?: 'No description provided.'); ?>

                                </dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Created</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($inventoryCategory->created_at->format('M j, Y \a\t g:i A')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($inventoryCategory->updated_at->format('M j, Y \a\t g:i A')); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <?php if($inventoryCategory->is_active): ?>
                            <a href="<?php echo e(route('inventory.create')); ?>?category_id=<?php echo e($inventoryCategory->id); ?>" 
                                        ...
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="hover:bg-gray-50">
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                    <div class="flex items-center">
                                                        <div class="h-8 w-8 rounded-lg flex items-center justify-center text-white text-xs font-bold mr-3"
                                                             style="background-color: <?php echo e($inventoryCategory->color); ?>;">
                                                            <?php echo e(strtoupper(substr($item->sku ?? $item->id, -2))); ?>

                                                        </div>
                                                        <div>
                                                            <div class="text-sm font-medium text-gray-900"><?php echo e($item->name); ?></div>
                                                            <div class="text-sm text-gray-500"><?php echo e($item->sku ?? 'SKU-' . $item->id); ?></div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td class="px-6 py-4 whitespace-nowrap">
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                    ...
                                                    <?php if(($item->quantity ?? 1) <= ($item->min_quantity ?? 0)): ?>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                    <a href="<?php echo e(route('inventory.show', $item)); ?>" class="text-blue-600 hover:text-blue-900">View</a>
                                                </td>
                                            </tr>
            ...
            <div class="space-y-6">
                    ...
                    <div class="p-6">
                        <dl class="space-y-4">
                            <div class="flex justify-between">
                                ...
                                <dd class="text-sm font-semibold text-gray-900"><?php echo e($stats['total_items'] ?? 0); ?></dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm font-medium text-gray-500">Available</dt>
                                <dd class="text-sm font-semibold text-green-600"><?php echo e($stats['available_items'] ?? 0); ?></dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm font-medium text-gray-500">Checked Out</dt>
                                <dd class="text-sm font-semibold text-yellow-600"><?php echo e($stats['checked_out_items'] ?? 0); ?></dd>
                            </div>
                            <div class="flex justify-between">
                                <dt class="text-sm font-medium text-gray-500">In Maintenance</dt>
                                <dd class="text-sm font-semibold text-red-600"><?php echo e($stats['maintenance_items'] ?? 0); ?></dd>
                            </div>
                            <?php if(($stats['low_stock_items'] ?? 0) > 0): ?>
                                <div class="flex justify-between border-t pt-4">
                                    <dt class="text-sm font-medium text-red-500">Low Stock Items</dt>
                                    <dd class="text-sm font-semibold text-red-600"><?php echo e($stats['low_stock_items']); ?></dd>
                                </div>
                            <?php endif; ?>
                        </dl>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    <div class="w-6 h-6 rounded border border-gray-300" style="background-color: <?php echo e($inventoryCategory->color); ?>;"></div>
                                    <span class="text-sm font-mono text-gray-600"><?php echo e(strtoupper($inventoryCategory->color)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <?php if(($stats['total_items'] ?? 0) > 0): ?>
                            <a href="<?php echo e(route('inventory.index')); ?>?category=<?php echo e($inventoryCategory->id); ?>" 
                               class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <!-- Related Categories -->
                <?php if($relatedCategories && $relatedCategories->count() > 0): ?>
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="px-6 py-4 border-b border-gray-200">
                        ...
                        <div class="p-6">
                            <div class="space-y-3">
                                <?php $__currentLoopData = $relatedCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $related): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <a href="<?php echo e(route('inventory.categories.show', $related)); ?>" 
                                       class="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-50 transition-colors">
                                        <div class="h-8 w-8 rounded-lg flex items-center justify-center text-white text-xs font-bold"
                                             style="background-color: <?php echo e($related->color); ?>;">
                                            <?php echo e(strtoupper(substr($related->code, 0, 2))); ?>

                                        </div>
                                        <div class="flex-1 min-w-0">
                                            <p class="text-sm font-medium text-gray-900 truncate"><?php echo e($related->name); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($related->items_count ?? 0); ?> items</p>
                                        </div>
                                    </a>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/categories/show.blade.php ENDPATH**/ ?>