...
<?php $__env->startSection('content'); ?>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-red-700 mt-1">
                                <?php echo e($items->count()); ?> <?php echo e($items->count() === 1 ? 'item' : 'items'); ?> currently below minimum stock levels. 
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="bg-red-50 hover:bg-red-100">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm">
                                            <div class="font-semibold text-red-600"><?php echo e($item->available_quantity); ?></div>
                                            <div class="text-xs text-gray-500">
                                                Total: <?php echo e($item->total_quantity); ?>

                                                <?php if($item->assigned_quantity > 0): ?>
                                                    | Assigned: <?php echo e($item->assigned_quantity); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                        <?php echo e($item->minimum_stock_level); ?>

                                    </td>
                                    
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            -<?php echo e($item->minimum_stock_level - $item->available_quantity); ?>
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium"><?php echo e($items->count()); ?></span> 
                                <?php echo e($items->count() === 1 ? 'item' : 'items'); ?> below minimum stock level
                            </div>
                            <div class="text-sm text-gray-500">
                                Total shortage: <span class="font-medium text-red-600"><?php echo e($items->sum(function($item) { return $item->minimum_stock_level - $item->available_quantity; })); ?></span> units
                            </div>
                        </div>
                    </div>
                <?php endif; ?>
            ...
            <!-- Quick Actions -->
            <?php if(Auth::user()->canManageStaff() && $items->count() > 0): ?>
                <div class="mt-8">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/low-stock.blade.php ENDPATH**/ ?>