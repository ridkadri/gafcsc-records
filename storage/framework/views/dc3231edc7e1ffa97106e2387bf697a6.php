...
<div class="flex justify-between items-center">
    <div class="flex items-center space-x-4">
        <div class="h-16 w-16 rounded-lg flex items-center justify-center text-white font-bold text-lg"
            ...
            <?php echo e(strtoupper(substr($category->code, 0, 4))); ?>

        </div>
        <div>
            <h1 class="text-2xl font-bold text-gray-900"><?php echo e($category->name); ?></h1>
            <div class="flex items-center space-x-4 text-sm text-gray-600">
                <span>Code: <span class="font-mono"><?php echo e($category->code); ?></span></span>
                ...
                <?php endif; ?>
                <span class="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium <?php echo e($category->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800'); ?>">
                    <svg class="w-3 h-3 mr-1" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="lg:col-span-2 space-y-6">
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 font-mono"><?php echo e($category->code); ?></dd>
                            </div>
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-medium text-gray-500">Description</dt>
                                <dd class="mt-1 text-sm text-gray-900">
                                    <?php echo e($category->description ?: 'No description provided.'); ?>

                                </dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Created</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($category->created_at->format('M j, Y \a\t g:i A')); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($category->updated_at->format('M j, Y \a\t g:i A')); ?></dd>
                            </div>
                        </dl>
                    </div>
                </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                        ...
                        <?php if($category->is_active): ?>
                            <a href="<?php echo e(route('inventory.create')); ?>?category_id=<?php echo e($category->id); ?>" 
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <div class="flex items-center space-x-2">
                                    <div class="w-6 h-6 rounded border border-gray-300" style="background-color: <?php echo e($category->color); ?>;"></div>
                                    <span class="text-sm font-mono text-gray-600"><?php echo e(strtoupper($category->color)); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="p-6 space-y-3">
                        ...
                        <?php if(($stats['total_items'] ?? 0) > 0): ?>
                            <a href="<?php echo e(route('inventory.index')); ?>?category=<?php echo e($category->id); ?>" 
                               class="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                                <svg class="w-4 h-4 mr-2" fill="currentColor" viewBox="0 0 20 20">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/gafcsc-records/resources/views/inventory/categories/show.blade.php ENDPATH**/ ?>