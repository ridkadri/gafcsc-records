...
<div class="flex justify-between items-center">
    <div class="flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-gray-600 text-sm"><?php echo e($inventoryCategory->name); ?> - Items requiring inspection or overdue</p>
        </div>
    </div>
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-red-900"><?php echo e($inspectionItems->total()); ?></p>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-yellow-900">
                            <?php echo e($inspectionItems->where('next_inspection', '<', now())->whereNotNull('next_inspection')->count()); ?>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">
                            <?php echo e($inspectionItems->whereNull('next_inspection')->count()); ?>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            ...
            <?php if($inspectionItems->count() > 0): ?>
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php $__currentLoopData = $inspectionItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50 <?php echo e($item->next_inspection && $item->next_inspection < now() ? 'bg-red-50' : ''); ?>">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="h-10 w-10 rounded-lg flex items-center justify-center text-white text-xs font-bold mr-3"
                                                 style="background-color: <?php echo e($inventoryCategory->color); ?>;">
                                                <?php echo e(strtoupper(substr($item->item_code ?? $item->id, -3))); ?>
                                            ...
                                            <div>
                                                ...
                                                <?php if($item->serial_number): ?>
                                                    <div class="text-xs text-gray-400">S/N: <?php echo e($item->serial_number); ?></div>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <?php elseif($item->status === 'needs_inspection'): ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php if($item->next_inspection && $item->next_inspection < now()): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                        ...
                                        <?php elseif(is_null($item->next_inspection)): ?>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800">
                                                Never Inspected
                                            </span>
                                        <?php else: ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php echo e($item->last_inspection_date ? $item->last_inspection_date->format('M j, Y') : 'Never'); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                        <?php if($item->next_inspection): ?>
                                            <span class="<?php echo e($item->next_inspection < now() ? 'text-red-600 font-medium' : ''); ?>">
                                                <?php echo e($item->next_inspection->format('M j, Y')); ?>

                                            </span>
                                            <?php if($item->next_inspection < now()): ?>
                                                <div class="text-xs text-red-500">
                                                    <?php echo e($item->next_inspection->diffForHumans()); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                                        ...
                                        <button onclick="scheduleInspection(<?php echo e($item->id); ?>)" 
                                                class="text-green-600 hover:text-green-900">Schedule</button>
                                        <?php if($item->activeAssignments->count() == 0): ?>
                                            <button onclick="markInspectedSingle(<?php echo e($item->id); ?>)" 
                ...
                <!-- Pagination -->
                <?php if($inspectionItems->hasPages()): ?>
                    <div class="bg-white px-4 py-3 border-t border-gray-200">
                        <?php echo e($inspectionItems->links()); ?>
...
<script>
    ...
    function exportReport() {
        const categoryId = <?php echo e($inventoryCategory->id); ?>;
    ...
    function sendReminders() {
        if (confirm('Send inspection reminders to relevant staff members?')) {
            fetch(`/inventory/categories/<?php echo e($inventoryCategory->id); ?>/send-inspection-reminders`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                    'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        if (confirm(`Mark ${selected.length} item(s) as inspected?`)) {
            fetch('/inventory/bulk-mark-inspected', {
                ...
                if (response.ok) {
                    ...
                    alert('Error updating inspection status');
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/needs-inspection.blade.php ENDPATH**/ ?>