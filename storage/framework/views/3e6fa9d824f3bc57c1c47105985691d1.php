...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('users.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                Back to Users
            </a>
        </div>
     <?php $__env->endSlot(); ?>
                    ...
                    <form method="POST" action="<?php echo e(route('users.store')); ?>" class="space-y-6">
                        ...
                        <div class="border-t border-gray-200 pt-6">
                            ...
                            <div class="space-y-3">
                                ...
                                <!-- Viewer Role -->
                                <label class="flex items-start space-x-3 p-4 border rounded-lg hover:bg-gray-50 cursor-pointer">
                                    <input type="radio" name="role" value="viewer" <?php echo e(old('role', 'viewer') === 'viewer' ? 'checked' : ''); ?> 
                        ...
                        <div class="flex items-center justify-between pt-6 border-t border-gray-200">
                            <a href="<?php echo e(route('users.index')); ?>" class="inline-flex items-center px-4 py-2 bg-gray-300 border border-transparent rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest hover:bg-gray-400">
                                Cancel
                            </a>
...
<?php endif; ?>
                                    <?php /**PATH /var/www/gafcsc-records/resources/views/users/create.blade.php ENDPATH**/ ?>