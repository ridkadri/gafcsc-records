    ...
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 text-gray-900">
                <form method="POST" action="<?php echo e(route('inventory.categories.store')); ?>" class="space-y-6">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="description" id="description" rows="3"
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                      placeholder="Brief description of what items belong in this category..."><?php echo e(old('description')); ?></textarea>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <div class="mt-1 flex items-center space-x-4">
                                    <input type="color" name="color" id="color" value="<?php echo e(old('color', '#6B7280')); ?>" required
                                           class="h-10 w-16 border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500">
                                    <div class="flex-1">
                                        <input type="text" name="color_hex" id="color_hex" value="<?php echo e(old('color', '#6B7280')); ?>"
                            ...
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input type="checkbox" name="requires_approval" id="requires_approval" value="1" 
                                           <?php echo e(old('requires_approval') ? 'checked' : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/categories/create.blade.php ENDPATH**/ ?>