                    ...
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="text-sm text-red-700 mt-1">
                                <?php echo e($assignments->count()); ?> <?php echo e($assignments->count() === 1 ? 'assignment' : 'assignments'); ?> are past their expected return dates.
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <div class="flex items-center space-x-4">
                            <span class="inline-flex items-center px-3 py-2 rounded-full text-sm font-medium bg-red-100 text-red-800">
                                <?php echo e($assignments->count()); ?> Overdue
                            </span>
                            <?php if(Auth::user()->canManageStaff() && $assignments->count() > 0): ?>
                ...
                <?php if(Auth::user()->canManageStaff()): ?>
                    <div id="bulk-actions" class="hidden px-6 py-4 bg-yellow-50 border-b border-yellow-200">
                        <form method="POST" action="<?php echo e(route('inventory.assignments.bulk-return')); ?>" onsubmit="return confirmBulkReturn()">
                            <?php echo csrf_field(); ?>
                            <div class="flex items-center space-x-4">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="bg-red-50 hover:bg-red-100">
                                    <?php if(Auth::user()->canManageStaff()): ?>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <input type="checkbox" name="assignment_ids[]" value="<?php echo e($assignment->id); ?>" 
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
                                            <?php echo e(abs($assignment->expected_return_date->diffInDays(now()))); ?> 
                                            <?php echo e(abs($assignment->expected_return_date->diffInDays(now())) === 1 ? 'day' : 'days'); ?>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <?php if(Auth::user()->canManageStaff()): ?>
                                            ...
                                            <form method="POST" action="<?php echo e(route('inventory.assignments.send-reminder', $assignment)); ?>" 
                                                  class="inline-block">
                                                <?php echo csrf_field(); ?>
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <tr>
                                    <td colspan="<?php echo e(Auth::user()->canManageStaff() ? '7' : '6'); ?>" class="px-6 py-12 text-center">
                    ...
                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                        <div class="flex justify-between items-center">
                            <div class="text-sm text-gray-600">
                                <span class="font-medium"><?php echo e($assignments->count()); ?></span> 
                                overdue <?php echo e($assignments->count() === 1 ? 'assignment' : 'assignments'); ?>

                            </div>
                            <div class="text-sm text-gray-500">
                                Oldest overdue: 
                                <span class="font-medium text-red-600">
                                    <?php echo e($assignments->sortBy('expected_return_date')->first()?->expected_return_date->diffForHumans()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/assignments/overdue.blade.php ENDPATH**/ ?>