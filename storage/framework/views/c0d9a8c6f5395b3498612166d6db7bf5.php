                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="flex items-start justify-between mb-8">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <a href="<?php echo e(route('users.reset-form', $user)); ?>" 
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-900 mt-1"><?php echo e($user->created_at->format('M d, Y')); ?></p>
                                </div>
                        ...
                        <div class="bg-gray-50 rounded-lg p-4 border">
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <p class="text-lg font-semibold text-gray-900 mt-1"><?php echo e($user->updated_at->format('M d, Y')); ?></p>
                                </div>
...
<?php endif; ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/users/show.blade.php ENDPATH**/ ?>