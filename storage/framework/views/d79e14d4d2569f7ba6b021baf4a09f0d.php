    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="<?php echo e(route('hod-management.store')); ?>">
                        <?php echo csrf_field(); ?>
                            ...
                            <div>
                                ...
                                <?php if($staff->count() > 0): ?>
                                    <select id="staff_id" name="staff_id" required 
                                            class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 <?php $__errorArgs = ['staff_id'];
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <?php $__currentLoopData = $staff->groupBy('department'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department => $departmentStaff): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <optgroup label="<?php echo e($department); ?>">
                                                <?php $__currentLoopData = $departmentStaff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($member->id); ?>" 
                                                            data-name="<?php echo e($member->name); ?>"
                                                            data-service="<?php echo e($member->service_number); ?>"
                                                            data-type="<?php echo e($member->type); ?>"
                                                            data-department="<?php echo e($member->department); ?>"
                                                            data-staff-count="<?php echo e(\App\Models\Staff::where('department', $member->department)->where('id', '!=', $member->id)->count()); ?>">
                                                        <?php echo e($member->name); ?> (<?php echo e($member->service_number); ?>)
                                                    </option>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center justify-end space-x-3 pt-4 border-t border-gray-200">
                                <a href="<?php echo e(route('hod-management.index')); ?>" 
                                ...
                                <button type="submit" 
                                        ...
                                        id="submitBtn"
                                        <?php echo e($staff->count() == 0 ? 'disabled' : ''); ?>>
...
<?php endif; ?><?php /**PATH /var/www/gafcsc-records/resources/views/hod-management/create.blade.php ENDPATH**/ ?>