                                ...
                                <div class="bg-white border-2 border-gray-200 rounded-lg p-6 hover:border-gray-300 transition-colors duration-200 <?php echo e(!$category->is_active ? 'opacity-60' : ''); ?>">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 mb-4">
                                        ...
                                        <?php if($category->items_count > 0): ?>
                                            <div class="text-center">
                                                <div class="text-2xl font-bold text-green-600">$<?php echo e(number_format($category->total_value, 0)); ?></div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.inventory', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/ridwankadri/Desktop/code/gafcsc-management/resources/views/inventory/categories/index.blade.php ENDPATH**/ ?>